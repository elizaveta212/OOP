...
void Seven::resize_arr(const size_t size)
{
    ...
    std::wmemcpy(reinterpret_cast<wchar_t*>(new_s_array), reinterpret_cast<const wchar_t*>(s_array), size);
...
Seven::Seven(const Seven& other)
{
    ...
    std::wmemcpy(reinterpret_cast<wchar_t*>(s_array), reinterpret_cast<const wchar_t*>(other.s_array), other.s_size);
